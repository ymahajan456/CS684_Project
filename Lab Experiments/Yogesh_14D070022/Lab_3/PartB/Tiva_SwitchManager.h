...
EXTERN int32_t g_ui32LongPressTime INITIALIZER(150);

extern void switchManager(int32_t *ui32PortStatus, int32_t ui32SWMask, int32_t *ui32SWFSMState, int32_t *ui32SWCount , int32_t *ui32PressCount, int32_t  *ui32LongPress);
